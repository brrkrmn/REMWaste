...
const Navbar = () => {
  ...
  return (
    <div className="w-full md:w-60 py-10 md:py-0 flex flex-row md:flex-col gap-4 sm:gap-8 justify-center items-center md:items-start md:fixed md:top-20 md:left-10">
